#!/usr/bin/env python
# Download from https://github.com/nii-yamagishilab/project-NN-Pytorch-scripts/blob/master/core_scripts/data_io/wav_tools.py
"""
data_io
...
def silence_handler(wav, sr, fl=320, fs=80, 
    ...
    frame_tag = np.asarray(frame_tag, dtype=int)
